            ...
            <section id="results" className="bg-[#030303] pb-16 pt-16 md:pb-32 border-t border-white/5">
                <div className="group relative m-auto max-w-5xl px-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-8 items-center justify-items-center opacity-70 hover:opacity-100 transition-opacity">
                        <div className="text-white/60 font-display font-bold text-lg hover:text-pharma-accent transition-colors text-center">PharmaFirstEnterprises</div>
                        <div className="text-white/60 font-display font-bold text-lg hover:text-pharma-accent transition-colors text-center">Pek Pharma</div>
                        <div className="text-white/60 font-display font-bold text-lg hover:text-pharma-accent transition-colors text-center">Crescent Pharma</div>
                        <div className="text-white/60 font-display font-bold text-lg hover:text-pharma-accent transition-colors text-center">Shaafi Pharma</div>
                        <div className="text-white/60 font-display font-bold text-lg hover:text-pharma-accent transition-colors text-center">Zain Pharma</div>
                    </div>
                </div>
            </section>
        </div>
